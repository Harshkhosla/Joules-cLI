  ...
  return (
    <Background>
      ...
      <Header style={styles.header}>
        {stateValue == '' ? 'Charging Status' : 'stateValue'}
      </Header>
      ...
      <Header onPress={() => navigation.navigate('Questionnaire')}>
        Questionnaire
      </Header>
      <Header onPress={() => navigation.navigate('SignIn')}>SignIn</Header>
      ...
      <View style={styles.modesContainer}>
        <TouchableOpacity style={styles.modeContainered}>
          ...
          <Text style={styles.sample}>
            Charger : {stateMode == '' ? '0 kW' : stateMode}
          </Text>
          {/* <View style={styles.modesContainer}>
  <Header>rgjng</Header>
</View> */}
        ...
        <TouchableOpacity style={styles.modeContainered}>
          ...
          {/* <Icon name="lightning-bolt-outline" size={180} color="#019031" /> */}
          <Image
      ...
      <View style={styles.modesContainer}>
        <TouchableOpacity
          onPress={Sample}
          style={
            button1 == 'true' ? styles.modeContainer : styles.modeContainer2
          }
        >
          <View style={styles.modeInnerContainer}>
            <Text
              style={button1 == 'true' ? styles.modeText : styles.modeText1}
            >
              Balanced Mode
            </Text>
            {/* <Text style={styles.modeText}> Mode</Text> */}
            <Text
              style={button1 == 'true' ? styles.modeStatus : styles.modeStatus1}
            >
              {button1 == 'true' ? 'ON' : 'OFF'}
            </Text>
          </View>
        ...
        <TouchableOpacity
          onPress={Samplee}
          style={
            button2 == 'true' ? styles.modeContainer : styles.modeContainer2
          }
        >
          <View style={styles.modeInnerContainer}>
            <Text
              style={button2 == 'true' ? styles.modeText : styles.modeText1}
            >
              Eco{'\n'}Mode
            </Text>
            {/* <Text style={styles.modeText}> Mode</Text> */}
            <Text
              style={button2 == 'true' ? styles.modeStatus : styles.modeStatus1}
            >
              {button2 == 'true' ? 'ON' : 'OFF'}
            </Text>
          </View>
        ...
        <TouchableOpacity
          onPress={Sampleed}
          style={
            button3 == 'true' ? styles.modeContainer : styles.modeContainer2
          }
        >
          <View style={styles.modeInnerContainer}>
            <Text
              style={button3 == 'true' ? styles.modeText : styles.modeText1}
            >
              Schedule Mode
            </Text>
            {/* <Text style={styles.modeText}> Mode</Text> */}
            <Text
              style={button3 == 'true' ? styles.modeStatus : styles.modeStatus1}
            >
              {button3 == 'true' ? 'ON' : 'OFF'}
            </Text>
          </View>
        ...
        <TouchableOpacity
          onPress={Sampleeeed}
          style={
            button4 == 'true' ? styles.modeContainer : styles.modeContainer2
          }
        >
          <View style={styles.modeInnerContainer}>
            <Text
              style={button4 == 'true' ? styles.modeText : styles.modeText1}
            >
              Slow Mode
            </Text>
            {/* <Text style={styles.modeText}>Mode</Text> */}
            <Text
              style={button4 == 'true' ? styles.modeStatus : styles.modeStatus1}
            >
              {button4 == 'true' ? 'ON' : 'OFF'}
            </Text>
          </View>
      ...
      <View style={styles.textSample}>
        <View style={styles.textContainer}>
          ...
          <Header style={styles.energy}>
            {stateEnergy == '' ? '0 Wh' : stateEnergy}
          </Header>
        </View>
        <View style={styles.textContainer}>
