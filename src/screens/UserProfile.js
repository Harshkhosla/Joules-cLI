    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.userInfoSection}>
        <View style={{ flexDirection: 'row', marginTop: 15 }}>
          <Avatar.Image source={photo} size={80} />
          <View style={{ marginLeft: 20 }}>
            ...
            >
              {UserData?.name == '' ? 'John Doe' : UserData?.name}
            </Title>
            <Caption style={styles.caption}>
              @{UserData?.name == '' ? '@j_doe' : UserData?.name}
            </Caption>
          </View>
        </View>
      </View>
      ...
      <View style={styles.userInfoSection}>
        <View style={styles.row}>
          ...
          <Text style={{ color: '#777777', marginLeft: 20 }}>
            {UserData?.city == '' ? 'Kolkata' : UserData?.city},{' '}
            {UserData?.state == '' ? 'India' : UserData?.state}
          </Text>
        </View>
        <View style={styles.row}>
          <Icon name="phone" color="#FF6347" size={20} />
          <Text style={{ color: '#777777', marginLeft: 20 }}>
            {UserData?.PhoneNo == '' ? '+91-900000009' : UserData?.PhoneNo}
          </Text>
        </View>
        <View style={styles.row}>
          <Image
            source={notifications}
            style={{ tintColor: '#FF6347', width: 20, height: 20 }}
            size={20}
          />
          <Text style={{ color: '#777777', marginLeft: 20 }}>
            {UserData?.email == '' ? 'john_doe@email.com' : UserData?.email}
          </Text>
        </View>
      </View>
